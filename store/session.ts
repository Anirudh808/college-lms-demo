...
export const useSession = create<SessionState>()(
  persist(
    (set, get) => ({
      ...
      logout: () => {
        // Wipe persisted storage so the next page load starts clean
      ...
      simulateNextDay: () => {
        const { creditsAllocatedDaily, creditsUsedToday, creditsExpiredTotal } = get();
    ...
    }),
    {
      ...
      partialize: (state) => ({
        ...
        creditsAllocatedDaily: state.creditsAllocatedDaily,
        creditsUsedToday: state.creditsUsedToday,
        creditsExpiredTotal: state.creditsExpiredTotal,
        usageByFeature: state.usageByFeature,
      }),
    }
  )
);
